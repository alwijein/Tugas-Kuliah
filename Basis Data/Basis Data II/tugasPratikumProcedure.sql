...
delimiter $$
	create procedure cekPegawai(out x varchar (20), out y varchar(20), out z enum ('L','P'), inout j ENUM('Karyawan', 'Kurir', 'Admin'), in i varchar(20))

begin
	select nama_pegawai,alamat,jenis_kelamin,bagian into x,y,z,j from pegawai where id_pegawai=i;
end$$

delimiter ;

call cekPegawai(@nama_pegawai,@alamat,@jenis_kelamin,@bagian,'P003');

select @nama_pegawai,@alamat,@jenis_kelamin,@bagian;
